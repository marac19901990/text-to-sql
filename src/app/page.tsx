...
import { AIMessage, BaseMessage, HumanMessage, mapChatMessagesToStoredMessages, SystemMessage } from "@langchain/core/messages"
    ...
    <div className="flex flex-col h-full">
      {messages.length > 0 && messages.map((message, index) => {
        ...
        if (message instanceof HumanMessage) {
          return (
            <div key={"message_key_" + index} className="col-start-1 col-end-8 p-3 rounded-lg">
        ...
        if (message instanceof AIMessage) {
          return (
            <div key={"message_key_" + index} className="col-start-6 col-end-13 p-3 rounded-lg">
